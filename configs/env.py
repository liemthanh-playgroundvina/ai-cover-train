...
class Settings(BaseSettings):
    ...
    AI_COVER_TRAIN = os.getenv("AI_COVER_TRAIN", "ai_cover_train")

    # AI COVER GEN
    APP_AI_COVER_GEN_DOMAIN = os.getenv("APP_AI_COVER_GEN_DOMAIN", "")
    ...
    AWS_BUCKET_NAME = os.getenv("AWS_BUCKET_NAME", "aiservices-bucket")
